...
public class JdbcFlightRouteDao implements FlightRouteDao {
	...
	public List<ScheduledFlight> searchFlights(String fromCity, String toCity,
		...
		try {
			...
			Collections.sort(scheduledFlights, new Comparator<ScheduledFlight>(){

				@Override
				public int compare(ScheduledFlight o1, ScheduledFlight o2) {
					for(FlightRouteCost flightRouteCost1 : o1.getFlightRouteCosts()){
						for(FlightRouteCost flightRouteCost2 : o2.getFlightRouteCosts()){
							return flightRouteCost1.compareTo(flightRouteCost2);
						}
					}
					return 0;
				}
