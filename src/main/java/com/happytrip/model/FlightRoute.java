...
public class FlightRoute implements Serializable {
	...
	private Set<FlightRouteCost> flightRouteCosts = new TreeSet<FlightRouteCost>();
	...
	public void addFlightRouteCost(FlightRouteCost flightRouteCost)
	{
		this.flightRouteCosts.add(flightRouteCost);
	}
